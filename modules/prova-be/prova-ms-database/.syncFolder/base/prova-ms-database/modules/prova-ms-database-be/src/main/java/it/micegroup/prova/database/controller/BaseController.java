package it.micegroup.prova.database.controller;

import it.micegroup.voila2runtime.controller.GenericController;
import it.micegroup.prova.database.domain.BaseEntity;
...
public abstract class BaseController<T extends BaseEntity> extends GenericController<T> {
	 ...
	 * Application name
	 */
	protected static final String APPLICATION_NAME = "prova-ms-database";
