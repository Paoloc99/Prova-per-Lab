...
public class OrdineController extends BaseController<Ordine> {
	...
	@PreAuthorize("hasRole(@permissionHolder.ORDINE_FIND_BY_THE_ORDER_ITEM_OBJECT_KEY.toString())")
	...
	@PreAuthorize("hasRole(@permissionHolder.ORDINE_FIND_BY_UTENTE.toString())")
