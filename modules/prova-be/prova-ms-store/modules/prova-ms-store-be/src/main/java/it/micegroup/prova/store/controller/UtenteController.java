...
import it.micegroup.prova.store.mapper.UtenteMappers;
import it.micegroup.prova.store.mapper.OrdineMappers;
import it.micegroup.prova.store.service.UtenteService;
...
public class UtenteController extends BaseController<Utente> {
	...
	@PreAuthorize("hasRole(@permissionHolder.UTENTE_SEARCH.toString())")
	...
	@PreAuthorize("hasRole(@permissionHolder.UTENTE_CREATE.toString())")
	...
	@PreAuthorize("hasRole(@permissionHolder.UTENTE_READ.toString())")
	...
	@PreAuthorize("hasRole(@permissionHolder.UTENTE_UPDATE.toString())")
	...
	@PreAuthorize("hasRole(@permissionHolder.UTENTE_DELETE.toString())")
	...
	@PreAuthorize("hasRole(@permissionHolder.UTENTE_FIND_BY_THE_ORDINE_OBJECT_KEY.toString())")
