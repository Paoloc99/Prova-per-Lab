...
public class ProvaMsStoreInterceptor implements HandlerInterceptor {

	private static Logger log = LoggerFactory.getLogger(ProvaMsStoreInterceptor.class);

	private MeterRegistry registry;
	private String URI, pathKey, METHOD;

	public ProvaMsStoreInterceptor(MeterRegistry registry) {
